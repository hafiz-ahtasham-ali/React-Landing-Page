...
const Hero = () => {
  return (
    <section className="relative w-full h-[210px] flex items-center justify-center bg-white text-[#4D4D4D] text-center">
      <div className="max-w-3xl px-4">
        ...
        <div className="flex justify-center items-center space-x-35 mt-6">
